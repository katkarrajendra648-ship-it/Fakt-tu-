...
<div class="container">
    ...
    <div class="slideshow-container" id="slideshow">
        <div class="slide">
            <img src="mine1.jpg" alt="mine1">
            <div class="caption">ur mine</div>
        </div>
        <div class="slide">
            <img src="mine2.jpg" alt="mine2">
            <div class="caption">ur my angel</div>
        </div>
        <div class="slide">
            <img src="mine3.jpg" alt="mine3">
            <div class="caption">ur my princess</div>
        </div>
        <div class="slide">
            <img src="mine4.jpg" alt="mine4">
            <div class="caption">ur everything. Anjali I love you so much much more and ever 🌍💋</div>
        </div>
    </div>
...
// YES/NO behavior
noBtn.addEventListener("mouseover",()=>{yesBtn.style.transform="scale(1.3)";});
noBtn.addEventListener("mouseout",()=>{yesBtn.style.transform="scale(1)";});
